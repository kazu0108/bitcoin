...
<center>
	...
	<div class="row text-center">
			<form class="form-horizontal" method="get" name="users">
...
?>
					<tbody>
						<td><input type="checkbox" value="<?php echo $row['user_id'];?> " name="check"></td>
      ...
      ?>
				...
				<div class="col-md-4">
					<a href="addusers.php" class="btn btn-info btn-lg">Add</a>
					<a onClick="view_users();" class="btn btn-warning btn-lg">View</a>
					<a onClick="edit_users();" class="btn btn-warning btn-lg">Edit</a>
					<a onClick="delete_users();" class="btn btn-danger btn-lg">Delete</a>
				</div>
			</form>
	</div>
</div>
