...
?>
					<tbody>
						<td><input type="checkbox" value="<?php echo $row['link_id'];?> " name="check"></td>
      ...
      ?>
				...
				<div class="col-md-4">
					<a href="addlink.php?check=<?php echo $id; ?>" class="btn btn-info btn-lg">Add</a>
					<a onClick="edit_link();" class="btn btn-warning btn-lg">Edit</a>
					<a onClick="delete_link();" class="btn btn-danger btn-lg">Delete</a>
				</div>
			</form>
	</div>
</div>
